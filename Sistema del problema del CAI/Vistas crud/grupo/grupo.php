...
$newTabla = $base_de_datos->prepare('
CREATE TABLE IF NOT EXISTS grupo(
    ...
    `UltimoIngresoEntrada` time NOT NULL,
    `UltimoIngresoSalida` time NOT NULL,
...
$name = "grupo" . $id;
$base_de_datos->query("RENAME TABLE grupo TO $name");
        ...
        <nav class="navbar navbar-dark bg-dark">
            ...
            <div class="card mx-auto" style="max-width:800px;">
                <div class="card-header">
                    <h3><b>Alumnos del Grupo <?php echo $id?></b></h3>
                ...
                <tbody>
                    <?php foreach($alumnosGrupo as $alumnosGrupo){?>   
                        <tr>
                            ...
                            <td><a href="<?php echo "eliminar.php?id=" . $alumnosGrupo->Matricula ?>">Eliminar</a></td>
                        </tr>
                    <?php } ?>
                 </tbody>
            </table>
            <div class="card-body">
                <a role="button" class="btn btn-info my-2 my-sm-0" href="<?php echo "https://sistemas-de-informacion.000webhostapp.com/Sistema del problema del CAI/Vistas crud/grupos/agregarAlumnos.php?id=" . $id ?>">Agregar alumnos</a>
